...
#include "../../a2ir/vins_type.h"

#include "draw_result/draw_result.hpp"
...
class Estimator
{
  public:
    ...
    Vector3d Ps[(WINDOW_SIZE + 1)]; // this for imu integration
    Vector3d Vs[(WINDOW_SIZE + 1)]; // this for imu integration
    Matrix3d Rs[(WINDOW_SIZE + 1)]; // this for imu integration
