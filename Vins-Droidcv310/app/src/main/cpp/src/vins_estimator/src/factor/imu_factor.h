...
// num_of_residual para_1_size para_2_size para_3_size para_4_size ....
// the jacobian size is determined by the parameter number, here is 4
// and jacobian[0] is num_of_residual * para_1_size
// and jacobian[1] is num_of_residual * para_2_size
// and jacobian[2] is num_of_residual * para_3_size
// and jacobian[3] is num_of_residual * para_4_size
...
//delta_q = Qi.inverse() * Qj;
        ...
        if (jacobians)
        {
            ...
            if (jacobians[0])
            {
                ...
                {
		            //VINS_LOG("WARN: numerical unstable in preintegration");
		            return false;
                }
            }
            if (jacobians[1])
