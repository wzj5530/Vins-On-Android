...
PinholeCamera::Parameters::readFromYamlFile(const std::string& filename)
{
    ...
    VINS_LOG("[INFO] LoadCamera: ImgWidth: %d, ImgHeight: %d", m_imageWidth, m_imageHeight);
    ...
    VINS_LOG("[INFO] LoadCamera: m_k1:%f,  m_k2:%f,  m_p1:%f,  m_p2:%f", m_k1, m_k2, m_p1, m_p2);
    VINS_LOG("[INFO] LoadCamera: m_fx:%f,  m_fy:%f,  m_cx:%f,  m_cy:%f", m_fx, m_fy, m_cx, m_cy);
    return true;
}
